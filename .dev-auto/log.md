...
## 2026-09-26 Epic 27 selection
Owner quote (current conversation): `$dev-auto 27`
Previous handoff was Epic 26 COMPLETE; current selection is Epic 27 only. Baseline dd6550b, clean tree at start. Epic 26 remains complete; its handoff text is in git at dd6550b:.dev-auto/handoff.md.

## 2026-09-26 Epic 27 early verification
Focused suite 151/151 PASS, typecheck-4 PASS, lint-2 PASS. Electron runs 1-2: hidden self-test window had no OS focus; main focus check rejected the send. Run 3: paste receipt arrived, but probe assumed an unwrapped path. Run 4: buffer showed the exact path wrapped across two rows. Run 5: app-side flow passed, main test expected the wrong target session. Run 6: app-side full gate passed; outer receipt contract still expected the old 9 reads. These are test-harness adjustments with raw logs under .dev-auto/evidence/epic-27-electron-{1..6}.log. Run 7 in flight.

Final candidate 7d62aaefd0ba08db588ba72d8a153e93d136810975f3d8ec5ac731869baa1263: focused-4 152/152, unit-2 1636/1636, typecheck-8, lint-5, electron-final1 EXIT 0. Electron raw receiver proved exact paste, one payload, no Enter; UI probe showed two workspaces, no default target, focus-loss reset, 50-result cap, skipped paths and preview route. Original full-unit sandbox run EPERM on Git/CLI spawning; same gate passed with authorized host access.

GLM-5.3/max quick Epic 27 pre-review: .dev-auto/evidence/epic-27-glm-pre-review.json, result RESULT: done, 0 material findings, 2 minors; observed 48,192 input + 177,856 cache-read / 15,124 output, $0.707988. Runtime-freshness gap CLOSED by epic-27-electron-final1.log EXIT 0. Minor failed-receipt message: accepted for repair. Minor vanished search root label: REJECTED as nonmaterial; "Directory unavailable" truthfully describes a removed/archived root and shows no stale rows. Missing live-directory/workspace-archive/root-symlink tests: accepted for focused test additions. No second GLM review planned.

Post-GLM consolidated repair: failed-state receipt retry wording is now exact; focused tests cover that state, live launch directory, workspace archive rejection and symlinked search root. focused-postglm 152/152, typecheck-postglm and lint-postglm PASS. Candidate fingerprint 54ae818113b5b92e63667861de359fb77335efa036d7f3443d2ff6facd881da2. Astra/medium full review dispatched read-only on sanitized packet; receipt pending epic-27-astra-review.md.

Astra/medium independent Epic 27 review: .dev-auto/evidence/epic-27-astra-review.md SHA256 6268d949e5f3f39ec4c1533cf962e5daf1fa72f588e5529850aeaa690d74bd59, RESULT: done, 4 material findings. Observed route gpt-6-astra/medium, read-only, approval never; 926,797 input (836,096 cached), 6,871 output; rollout 01a0dc89-5c3d-7a81-8123-f451954b2fad. F1 archive race; F2 raw palette path misparse; F3 foreign split pane root; F4 stale result under new root label. All pending reproduction and one repair wave; rechecks used 0.

Epic 27 consolidated post-review repair: F1/F3 controlled RED in epic-27-review-red-unit.log (SHA256 a4609cf3...) then GREEN in epic-27-review-f1f3-green.log (d904e2bb...); final availability is one DB transaction and the foreign selected session resolves to its owning workspace. F2 original Electron RED in epic-27-review-red-electron.log (5c470731...): selecting report:42 opened the sibling report. Repaired palette round-trips the existing grammar, opens a:b.ts exactly and honestly rejects unrepresentable report:42; final Electron receipt proves both and foreign-pane preview. F4 keys palette results and effect to the root; command-palette.test.ts checks stale rows hide under root change. Frozen source/test fingerprint f5e360c029974ae86efa5cb16d42de2069428402eec44813a54fbe31f870090b, sorted path/length/content SHA256 over 24 files. Gates: focused 6 files/155 PASS (epic-27-review-focused.log, 3e645e98...); full unit 102 files/1639 PASS (epic-27-review-unit.log, 36e5a3c8...); typecheck/lint EXIT 0; isolated Electron EXIT 0 (epic-27-review-electron.log, 7eaad867...), 15 reads and all six raw wire checks true. Recheck packet /tmp/bmn-epic27-review-20260926 prepared with source, prior review, dispositions and synthetic evidence; Astra/low first recheck pending dispatch. No source edits while the reviewer reads.

Astra/low first recheck dispatched via `codex exec` on the frozen sanitized packet, read-only sandbox and approval_policy=never, output epic-27-astra-recheck.md and launch log; terminal receipt and observed usage pending. Review allowance now has first recheck in flight; no source edits during read.

Astra/low first recheck terminal receipt epic-27-astra-recheck.md SHA256 db57b237d7c6eef9e7347498b5f52ec12a3b79cd918b250da174727e19860e5e, RESULT: done, verdict BLOCKED: F2/F3 closed, F1/F4 unresolved. F1: a DB archive can commit after final worker snapshot but before response/write; controlled extracted service probe wrote once. F4: exit retains live startup cwd in renderer while utility switches to stored cwd; rootLabel stays old and old results remain. First recheck's material gaps are continuations of original findings, not introduced new features; one further repair/recheck remains before the workflow's hard stop on a second material recheck. Reviewer observed gpt-6-astra/low, read-only, approval never; rollout 01a0dc9b-4cf7-79d1-9ab2-0d4424083376, 489,363 input (416,768 cached), 4,651 output. Candidate remains frozen until reproduction and coherent repair design.

Epic 27 second repair: F1 response-gap RED on prior behavior even with a proposed no-op host marker (epic-27-review-response-gap-red.log SHA256 588d15e1...): one paste after workspace archive. Host RPC workspace archive and session archive/move now announce a synchronous epoch change before any await; paste claim and post-worker-response checks reject overlap before synchronous PTY write. The strengthened GREEN test finishes the archive marker before releasing the held worker response, proving the epoch rather than only a pending flag closes the gap (epic-27-response-gap-completed-green.log aca9b247...). F4 exited-session root RED on prior live-first expression (epic-27-review-exit-root-red.log 062222e2...); renderer root helper now consults sessionProcessLive, using stored cwd after exit, and unit search exercise confirms utility switches to that root. Second candidate fingerprint fb91ab0cfff06e6de26318f5355046119bcd423847b1adb73d456be8b16824f5 over 25 task source/test files. Focused final 6 files/157 PASS (epic-27-second-focused-final.log 1c70c4c2...), full unit final 102 files/1641 PASS (epic-27-second-unit-final.log 154ddd6e...), typecheck/lint EXIT 0, Electron retry EXIT 0 (epic-27-second-electron-retry.log b6022572..., six wire checks true). First identical Electron gate failed before Epic 27 in the existing native-dependency probe with empty child stderr (epic-27-second-electron.log); retry passed. Second recheck packet /tmp/bmn-epic27-review-20260926 prepared; second material recheck would require stopping repairs and consulting once per skill.

Astra/low second focused recheck dispatched via read-only codex exec, approval_policy=never, on frozen packet fb91ab0c...; output epic-27-astra-recheck2.md pending. No source edits while it reads.

Astra/low second focused recheck completed: epic-27-astra-recheck2.md SHA256 950201d75d5d3a1f616b0f2e3d0f1c1951610dcb02d8bd24ffe50c5a5f2445be, RESULT: done. F1/F4 closed on the inspected product path; F2/F3 remain closed; no new material defect. The reviewer recomputed all 25 source/test file hashes and tracked diff, executed controlled host-route/paste overlap probes (archive completed and archive pending both reject with zero writes, normal one write), and root-helper live/exited cases. It identified the direct unmarked SQL mutation boundary as outside actual RPC product paths. Remaining runtime evidence limits: real RPC/worker scheduling overlap, Electron exit with in-flight search/Enter, OS focus, crash persistence, slow I/O cancellation, symlink replacement. These are unverified, not demonstrated defects. Observed route gpt-6-astra/low, read-only, approval never; rollout 01a0dca8-befd-7760-a368-b8fcf376e568, 361,554 input (299,520 cached), 3,423 output. Review yield: 4 original material, all closed in two rechecks, no new material.

Epic 27 acceptance: original Story 27.1/27.2 criteria in epics.md:1438-1482 reconciled against exact-payload chooser/guarded PTY path, bounded on-demand search and existing preview route. Accepted source/test fingerprint fb91ab0cfff06e6de26318f5355046119bcd423847b1adb73d456be8b16824f5; full unit 102 files/1641 PASS, focused 6 files/157 PASS, typecheck/lint EXIT 0, isolated Electron EXIT 0 on one retry with all six wire assertions true and 15 exact preview reads. Board epic-27, 27-1, 27-2 atomically set to done and read back; `_bmad-output` is ignored by Git, so this local board state is not in the task commit. First second-candidate Electron run failed before Epic 27 in native dependency self-test with empty stderr; repeat of same gate passed. No real owner workspace/profile/session was used. Cockpit mirror was skipped after `bmn progress` hit EPERM on BMN socket, per optional cockpit rule. Lead observed gpt-6-sol/xhigh codex-tui rollout 01a0dc66-2ace-7681-8bb3-0ef3f54af2b5, latest read 52,207,054 input (51,516,032 cached), 152,967 output. Two separate codex-auto-review/low sessions (01a0dc6e and 01a0dc97) were seen in usage listing and not added to lead usage. Push, merge, deploy and desktop update were not authorized; ready local task commit follows.

## 2026-09-26 owner-authorized Epic 27 delivery follow-up
Owner quote (current conversation): "dispatch glm and glm flash models, double check everything when you're confidet about the epic - update local and push to GH. Let glm models make sure that docs are up to date for BMN and that we don't have any serious issues with BMN"
This later instruction authorizes the named read-only GLM/Flash dispatches, GitHub push and local desktop update after checks; it supersedes the original no-push/no-update boundary for this delivery. Source commit 4d7b288 remained unchanged throughout the recheck. Before edits, the working tree was clean and main one commit ahead of origin/main.

GLM-5.3/max source review (`.dev-auto/evidence/epic-27-owner-glm-strong.receipt.json`, SHA256 2151f4340be48e7444ba46ee48530f5dd4f6d1c3b2d1233aab72a5510e367c8f) reported zero material findings in the changed Epic 27 code paths; it explicitly limited its verdict to source inspection and named symlink-swap and post-IPC blur as minor edges. Observed usage: 48,420 input + 413,504 cache-read / 11,447 output, $0.735027. GLM-5.3-Flash/max documentation audit (`epic-27-owner-glm-flash.receipt.json`, SHA256 316f1915186bb1c8c86f793bf81f4f585df80dbcdcc2b09a3ab2bc7ef6334a2c) reported eight missing or incomplete user/architecture statements, no false existing claims or other serious doc error in the checked eight docs. Observed usage: 54,355 input + 355,776 cache-read / 7,152 output, $0.628463. README.md, docs/features.md and docs/architecture.md now describe explicit no-Enter send, the palette file search/root/caps and the guarded paste boundary. Flash's focused recheck (`epic-27-owner-docs-recheck.receipt.json`, SHA256 96113016d0f06df876432bc5b90ab3a2479c18d01e8fdc53c6225481474b3e36) closed all eight and found no false promise in the edits; observed usage 15,195 input + 30,784 cache-read / 3,328 output, $0.174567.

Full local recheck on unchanged product source (`.dev-auto/evidence/epic-27-owner-gates.log`, SHA256 8afb33b442cac303024043d679d9d0a8723ed1e71e518f851b5a59de5c7b33c3): unit 102/102 files and 1641/1641 tests PASS; typecheck, lint and isolated Electron each EXIT 0. Parsed Electron receipt: six `fileReferenceWire` assertions true (exact payload, target, receipt, exact paste, no Enter, one paste); chooser default empty and cross-workspace, 50 capped rows, superseded rows absent, colon filename exact, numeric-suffix refusal, foreign-session preview. `git diff --check` PASS after docs edits. Runtime limitations remain the ones in the accepted handoff; no real owner workspaces/profiles/sessions were used.
