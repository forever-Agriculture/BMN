...
- Next safe action: commit story 13.1, then implement 13.2 (the "What survives" table in `docs/architecture.md`, `bmn help agents`, the fenced copy in `docs/agent-control.md` with a drift test, README link, self-test row assertions), then one full epic review.
- Status: ACTIVE
