...
- Lead host / requested model / observed model: Codex host; no model requested; observed model unavailable.
...
- Observed usage: host accounting unavailable; 2 native helpers, with the reviewer reused for focused rechecks. Fable receipts: high `$3.4192`, 275 turns; medium `$0.8810`, 19 turns; no web use.
